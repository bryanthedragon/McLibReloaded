    ...
    public static BehaviorControl<LivingEntity> create() {
        return BehaviorBuilder.create(
            p_259979_ -> p_259979_.group(
                ...
                .apply(p_259979_, (p_260219_, p_260252_, p_260090_, p_259577_, p_260020_) -> (p_390630_, p_390631_, p_390632_) -> {
                    p_260219_.set(Unit.INSTANCE);
                    p_260090_.setWithExpiry(Unit.INSTANCE, SNIFF_COOLDOWN.sample(p_390630_.getRandom()));
                    p_260252_.erase();
                    p_390631_.setPose(Pose.SNIFFING);
                    return true;
                })
        );
    }
