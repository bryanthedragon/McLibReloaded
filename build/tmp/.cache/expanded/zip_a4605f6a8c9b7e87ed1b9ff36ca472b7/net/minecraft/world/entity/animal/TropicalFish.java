...
public class TropicalFish extends AbstractSchoolingFish {
    ...
    public void addAdditionalSaveData(CompoundTag p_30033_) {
        ...
        p_30033_.store("Variant", TropicalFish.Variant.CODEC, new TropicalFish.Variant(this.getPackedVariant()));
    }

    @Override
    public void readAdditionalSaveData(CompoundTag p_30029_) {
        super.readAdditionalSaveData(p_30029_);
        TropicalFish.Variant tropicalfish$variant = p_30029_.read("Variant", TropicalFish.Variant.CODEC).orElse(DEFAULT_VARIANT);
