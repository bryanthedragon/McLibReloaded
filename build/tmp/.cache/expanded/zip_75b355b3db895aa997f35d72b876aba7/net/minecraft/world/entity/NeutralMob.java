...
public interface NeutralMob {
    ...
    default void addPersistentAngerSaveData(CompoundTag p_21679_) {
        ...
        p_21679_.storeNullable("AngryAt", UUIDUtil.CODEC, this.getPersistentAngerTarget());
    }

    default void readPersistentAngerSaveData(Level p_147286_, CompoundTag p_147287_) {
        this.setRemainingPersistentAngerTime(p_147287_.getIntOr("AngerTime", 0));
        if (p_147286_ instanceof ServerLevel serverlevel) {
            UUID $$4 = p_147287_.read("AngryAt", UUIDUtil.CODEC).orElse(null);
