...
public class ChickenVariants {
    ...
    public static Optional<Holder.Reference<ChickenVariant>> selectVariantToSpawn(RandomSource p_395793_, RegistryAccess p_394035_, SpawnContext p_393856_) {
        return PriorityProvider.pick(p_394035_.lookupOrThrow(Registries.CHICKEN_VARIANT).listElements(), Holder::value, p_395793_, p_393856_);
    }
}