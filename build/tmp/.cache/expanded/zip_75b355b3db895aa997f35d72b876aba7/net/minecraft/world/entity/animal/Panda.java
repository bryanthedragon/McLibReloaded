...
public class Panda extends Animal {
    ...
    public void addAdditionalSaveData(CompoundTag p_29129_) {
        ...
        p_29129_.store("MainGene", Panda.Gene.CODEC, this.getMainGene());
        p_29129_.store("HiddenGene", Panda.Gene.CODEC, this.getHiddenGene());
    }

    @Override
    public void readAdditionalSaveData(CompoundTag p_29115_) {
        super.readAdditionalSaveData(p_29115_);
        this.setMainGene(p_29115_.read("MainGene", Panda.Gene.CODEC).orElse(Panda.Gene.NORMAL));
        this.setHiddenGene(p_29115_.read("HiddenGene", Panda.Gene.CODEC).orElse(Panda.Gene.NORMAL));
    }
