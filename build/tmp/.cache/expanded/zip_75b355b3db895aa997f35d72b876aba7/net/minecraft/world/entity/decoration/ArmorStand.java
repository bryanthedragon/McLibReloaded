...
public class ArmorStand extends LivingEntity {
    ...
    public void readAdditionalSaveData(CompoundTag p_31600_) {
        ...
        this.setInvisible(p_31600_.getBooleanOr("Invisible", false));
        this.setSmall(p_31600_.getBooleanOr("Small", false));
        this.setShowArms(p_31600_.getBooleanOr("ShowArms", false));
        this.disabledSlots = p_31600_.getIntOr("DisabledSlots", 0);
        this.setNoBasePlate(p_31600_.getBooleanOr("NoBasePlate", false));
        this.setMarker(p_31600_.getBooleanOr("Marker", false));
        this.noPhysics = !this.hasPhysics();
        this.readPose(p_31600_.getCompoundOrEmpty("Pose"));
    }

    private void readPose(CompoundTag p_31658_) {
        this.setHeadPose(p_31658_.read("Head", Rotations.CODEC).orElse(DEFAULT_HEAD_POSE));
        this.setBodyPose(p_31658_.read("Body", Rotations.CODEC).orElse(DEFAULT_BODY_POSE));
        this.setLeftArmPose(p_31658_.read("LeftArm", Rotations.CODEC).orElse(DEFAULT_LEFT_ARM_POSE));
        this.setRightArmPose(p_31658_.read("RightArm", Rotations.CODEC).orElse(DEFAULT_RIGHT_ARM_POSE));
        this.setLeftLegPose(p_31658_.read("LeftLeg", Rotations.CODEC).orElse(DEFAULT_LEFT_LEG_POSE));
        this.setRightLegPose(p_31658_.read("RightLeg", Rotations.CODEC).orElse(DEFAULT_RIGHT_LEG_POSE));
    }
