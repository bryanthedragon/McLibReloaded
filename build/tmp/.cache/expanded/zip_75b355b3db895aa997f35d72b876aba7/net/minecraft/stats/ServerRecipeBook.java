...
public class ServerRecipeBook extends RecipeBook {
    ...
    public void fromNbt(CompoundTag p_12795_, Predicate<ResourceKey<Recipe<?>>> p_362297_) {
        ...
        List<ResourceKey<Recipe<?>>> list = p_12795_.read("recipes", RECIPE_LIST_CODEC).orElse(List.of());
        this.loadRecipes(list, this::add, p_362297_);
        List<ResourceKey<Recipe<?>>> list1 = p_12795_.read("toBeDisplayed", RECIPE_LIST_CODEC).orElse(List.of());
        this.loadRecipes(list1, this::addHighlight, p_362297_);
    }
