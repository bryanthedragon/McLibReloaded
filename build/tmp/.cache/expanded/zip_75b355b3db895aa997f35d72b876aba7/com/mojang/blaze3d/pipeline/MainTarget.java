...
public class MainTarget extends RenderTarget {
    ...
    private GpuTexture allocateColorAttachment(MainTarget.Dimension p_166140_) {
        try {
            return RenderSystem.getDevice().createTexture(() -> this.label + " / Color", TextureFormat.RGBA8, p_166140_.width, p_166140_.height, 1);
    ...
    private GpuTexture allocateDepthAttachment(MainTarget.Dimension p_166145_) {
        try {
            return RenderSystem.getDevice()
                .createTexture(() -> this.label + " / Depth", TextureFormat.DEPTH32, p_166145_.width, p_166145_.height, 1);
        } catch (GpuOutOfMemoryException gpuoutofmemoryexception) {
            return null;
        }
    }
