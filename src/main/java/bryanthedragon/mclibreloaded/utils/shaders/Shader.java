package bryanthedragon.mclibreloaded.utils.shaders;
...
public class Shader
{
    ...
    public void CompileShader(String vertexPath, String fragmentPath, boolean code) throws Exception
    {
        if (this.programId != -1)
        {
            return;
    ...
    /**
     * Creates a shader of a given type and attaches it to the program.
     * @param shaderPath The path to the shader. If code is true, this is the shader code itself.
     * @param shaderType The type of shader to create. Types are defined in GL20.
     * @param code Whether shaderPath is a file path or the shader code itself.
     * @return The id of the shader.
     * @throws Exception If there is an error compiling the shader.
     */
