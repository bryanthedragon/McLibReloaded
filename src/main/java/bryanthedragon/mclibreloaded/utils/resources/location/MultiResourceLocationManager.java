...
public class MultiResourceLocationManager
{
    ...
    /**
     * Get the unique id associated with the given MultiResourceLocation.
     * 
     * The id is generated by this class, and is used to identify the
     * MultiResourceLocation. If the MultiResourceLocation is empty, returns
     * -1.
     * 
     * @param location the MultiResourceLocation to get the id for
     * @return the id of the given MultiResourceLocation, or -1 if the
     *         MultiResourceLocation is empty
     */
