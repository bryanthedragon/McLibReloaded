...
import bryanthedragon.mclibreloaded.forge.fml.common.gameevent.InputEvent;
import bryanthedragon.mclibreloaded.forge.fml.common.gameevent.PlayerEvent;
import bryanthedragon.mclibreloaded.forge.fml.common.gameevent.TickEvent;
import bryanthedragon.mclibreloaded.forge.fml.common.gameevent.TickEvent.Phase;
...
//        MinecraftForge.registerCrashCallable();
     ...
     * @param hardExit Perform a halt instead of an exit (only use when the world is unsalable) - read the warnings at {@link Runtime#halt(int)}
     */
