...
package bryanthedragon.mclibreloaded.forge.fml.relauncher;
...
import bryanthedragon.mclibreloaded.forge.fml.common.CertificateHelper;
import bryanthedragon.mclibreloaded.forge.fml.common.FMLLog;
import bryanthedragon.mclibreloaded.forge.fml.common.asm.ASMTransformerWrapper;
import bryanthedragon.mclibreloaded.forge.fml.common.asm.transformers.ModAccessTransformer;
import bryanthedragon.mclibreloaded.forge.fml.common.launcher.FMLInjectionAndSortingTweaker;
import bryanthedragon.mclibreloaded.forge.fml.common.launcher.FMLTweaker;
import bryanthedragon.mclibreloaded.forge.fml.relauncher.IFMLLoadingPlugin.DependsOn;
import bryanthedragon.mclibreloaded.forge.fml.relauncher.IFMLLoadingPlugin.MCVersion;
import bryanthedragon.mclibreloaded.forge.fml.relauncher.IFMLLoadingPlugin.Name;
import bryanthedragon.mclibreloaded.forge.fml.relauncher.IFMLLoadingPlugin.SortingIndex;
import bryanthedragon.mclibreloaded.forge.fml.relauncher.IFMLLoadingPlugin.TransformerExclusions;
import bryanthedragon.mclibreloaded.forge.fml.relauncher.libraries.Artifact;
import bryanthedragon.mclibreloaded.forge.fml.relauncher.libraries.LibraryManager;
import bryanthedragon.mclibreloaded.forge.fml.relauncher.libraries.Repository;
...
public class CoreModManager {
    ...
    private static void discoverCoreMods(File mcDir, LaunchClassLoader classLoader)
    {
        ...
        List<Artifact> maven_candidates = LibraryManager.flattenLists(mcDir);
        List<File> file_candidates = LibraryManager.gatherLegacyCanidates(mcDir);
        ...
        for (File coreMod : file_candidates)
        {
