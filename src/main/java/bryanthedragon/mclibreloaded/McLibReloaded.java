...
import bryanthedragon.mclibreloaded.config.ConfigThread;
...
{
    public static final String MOD_ID = "mclibreloaded";
    ...
    public static ConfigThread proxy;
    ...
    public void onConfigRegister(RegisterConfigEvent event)
    {
        ...
        tooltipStyle = builder.getInt("tooltip_style", 1).modes(IKey.lang("mclibreloaded.tooltip_style.light"), IKey.lang("mclibreloaded.tooltip_style.dark"));
        ...
        keystrokeMode = builder.getInt("keystroke_position", 1).modes(IKey.lang("mclibreloaded.keystrokes_position.auto"), IKey.lang("mclibreloaded.keystrokes_position.bottom_left"), IKey.lang("mclibreloaded.keystrokes_position.bottom_right"), IKey.lang("mclibreloaded.keystrokes_position.top_right"), IKey.lang("mclibreloaded.keystrokes_position.top_left"));
        builder.getCategory().markClientSide();
