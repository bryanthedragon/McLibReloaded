...
public class GuiElement extends Gui implements IGuiElement
{
     ...
     * @throws NullPointerException if element is null
     */
    public void add(IGuiElement element, GuiElement second, GuiElement third)
    {
        if (this.children == null)
        {
            this.children = new GuiElements<IGuiElement>(this);
    ...
    public void add(GuiLabel tz, GuiToggleElement autoSize, GuiTrackpadElement rz, GuiTrackpadElement drz) {
