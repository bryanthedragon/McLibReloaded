...
import bryanthedragon.mclibreloaded.client.gui.framework.elements.utils.GuiDrawable;
...
public class GuiPanelBase<T extends GuiElement> extends GuiElement
{
    ...
    public GuiPanelBase(Minecraft mc, Direction direction)
    {
        ...
        this.addArray(this.view, new GuiDrawable(this::drawOverlay), this.buttons);
    }
    ...
    public GuiIconElement registerPanel(T panel, IKey tooltip, Icon icon)
    {
        ...
        {
            button.tooltipDirection(tooltip, this.direction.opposite());
        }
    ...
    {
        return this.keys().register(label, key, () -> element.clickItself(GuiBase.getCurrent(), key));
    }
