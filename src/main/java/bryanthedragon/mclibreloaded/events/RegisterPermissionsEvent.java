...
public class RegisterPermissionsEvent extends Event
{
    ...
    */
    public void registerMod(String modid, DefaultPermissionLevel permissionlevel)
    {
        this.currentMod = new PermissionCategory(modid, permissionlevel);
    ...
    * and register them into the permission factory {@link McLib#permissionFactory}.
    */
    public void loadPermissions()
    {
        for (PermissionCategory permission : this.permissions)
        {
            ...
            McLibPermissions.registerNode(permission.toString(), permission.getDefaultPermission(), "");
